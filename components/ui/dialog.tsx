  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-[calc(100%-2rem)] max-w-2xl -translate-x-1/2 -translate-y-1/2 gap-4 rounded-[var(--radius)] border border-border bg-background p-6 shadow-xl opacity-0 scale-[0.98] transition data-[state=open]:opacity-100 data-[state=open]:scale-100",
          className,
        )}
        {...props}
      >
